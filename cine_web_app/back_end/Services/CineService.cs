            ...
            {
                {
                    ...
                    {
                        // Día 0
                        { fechaBase.AddDays(0).ToString("yyyy-MM-dd"), new List<Sesion>
                            {
                        ...
                        // Día 1
                        { fechaBase.AddDays(1).ToString("yyyy-MM-dd"), new List<Sesion>
                            {
                        ...
                        // Día 2
                        { fechaBase.AddDays(2).ToString("yyyy-MM-dd"), new List<Sesion>
                            {
                        ...
                        // Día 3
                        { fechaBase.AddDays(3).ToString("yyyy-MM-dd"), new List<Sesion>
                            {
                        ...
                        // Día 4
                        { fechaBase.AddDays(4).ToString("yyyy-MM-dd"), new List<Sesion>
                            {
