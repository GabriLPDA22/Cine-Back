 ...
 _productos = new List<Producto>
        {
            ...
            new Producto { Id = 1, Nombre = "Menu Halloween Funko", Categorias = new List<string> { "Top Ventas", "Menus" }, Precio = 24.90M, ImagenUrl = "/cine_web_app/front-end/images/menu_halloween_funko.jpg" },
            new Producto { Id = 2, Nombre = "Menu Joker Funko", Categorias = new List<string> { "Top Ventas", "Menus" }, Precio = 23.90M, ImagenUrl = "/cine_web_app/front-end/images/Menu-Funko-Joker.jpg" },
            new Producto { Id = 5, Nombre = "Menu Haribo UP CH", Categorias = new List<string> { "Top Ventas", "Snacks Dulces" }, Precio = 22.30M, ImagenUrl = "/cine_web_app/front-end/images/menu_haribo.jpg" },
            ...
            new Producto { Id = 18, Nombre = "Agua 75CL Stock", Categorias = new List<string> { "Bebidas" }, Precio = 2.60M, ImagenUrl = "/cine_web_app/front-end/images/agua_75cl.jpg" },
            ...
            new Producto { Id = 24, Nombre = "Peluche Foxy Stock", Categorias = new List<string> { "Merchandising" }, Precio = 15.00M, ImagenUrl = "/cine_web_app/front-end/images/peluche_foxy.jpg" },

            // Productos para Infantil
            new Producto { Id = 10, Nombre = "Infantil Bitty Pop CH", Categorias = new List<string> { "Infantil", "Snacks Dulces","Menus" }, Precio = 10.90M, ImagenUrl = "/cine_web_app/front-end/images/infantil_bitty_pop.jpg" },

            // Productos para Menus (que no están en Top Ventas, Bebidas, o Merchandising)
            new Producto { Id = 3, Nombre = "Menu Bucket Topuria", Categorias = new List<string> { "Menus", "Palomitas" }, Precio = 14.20M, ImagenUrl = "/cine_web_app/front-end/images/menu_bucket_topuria.jpg" },
            new Producto { Id = 4, Nombre = "Menu Transformers CH", Categorias = new List<string> { "Menus", "Palomitas" }, Precio = 15.20M, ImagenUrl = "/cine_web_app/front-end/images/menu_transformers.jpg" },
            new Producto { Id = 8, Nombre = "Menu Duo Taylor Swift The Eras Tour", Categorias = new List<string> { "Menus", "Hot Food" }, Precio = 16.40M, ImagenUrl = "/cine_web_app/front-end/images/menu_duo_taylor_swift.jpg" },
            new Producto { Id = 12, Nombre = "Menu Gladiator Vaso CH", Categorias = new List<string> { "Menus", "Merchandising" }, Precio = 29.50M, ImagenUrl = "/cine_web_app/front-end/images/menu_gladiator.jpg" }
        };
    }
